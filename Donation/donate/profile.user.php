...
if(isset($_SESSION)&&!empty($_SESSION))
{
    ...
    $sql2="SELECT First_Name,Last_Name, Email, Phone,City,Gender  FROM user where ID=$ID";
...
<div id="mySidenav" class="sidenav">
    ...
    <a href="profile.user.php" target="_self"><i class="fa-solid fa-truck" ></i> Profile</a>
    <a href="Donation.html" target="_self"><i class="fa-solid fa-truck" ></i> Donate</a>
